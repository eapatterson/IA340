...
--Q2.5 
/* you need to modify the professor table first because you need to add the new professor record before you can add it to the course.*/
insert into professor(p_email,p_name,office)
...
--Q2.6 
/*You need to modify the course table first because you need to change the p_email in the course before you delete the professors(p1) records. If p1 is teaching the course you cannot delete it*/
update course
